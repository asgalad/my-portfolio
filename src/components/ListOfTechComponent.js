    ...
    return (
        <div className="col">
            ...
            <div className="row justify-content-between mx-auto">
                ...
                <div>
                    <img className="text-right mx-2 mb-2" src={vue} alt="Vue Js" height="50"/>
                    <p className="small">Vue JS</p>
                </div>
                <div>
                    <img className="text-right mx-2 mb-2" src={vuetify} alt="Vuetify" height="50"/>
                    <p className="small">Vuetify</p>
                </div>
                <div>
                    <img className="text-right mx-2 mb-2" src={Node} alt="Node" height="50"/>
                    <p className="small">Node Js</p>
                </div>
                <div>
